...
(function() {
  ...
  BusEditor.Map.Route = (function(_super) {
    ...
    function Route(gmap, coordinates, options) {
      Route.__super__.constructor.call(this, gmap, coordinates, options);
      this.bind_events();
    }
...
(function() {
  ...
  BusEditor.Map.BusRoute = (function(_super) {
    ...
    function BusRoute(_, checkpoints, options) {
      this.checkpoints = checkpoints;
      BusRoute.__super__.constructor.call(this, _, this.checkpoints_to_coordinates(), options);
    }
...
(function() {
  ...
  BusEditor.Route.InputsHandler = (function() {
    ...
    function InputsHandler(map, container, options) {
      ...
      this.route = new BusEditor.Map.BusRoute(this.map.gmap, this.checkpoints, options);
      this.bind_events();
    }
...
(function() {
  ...
  $(function() {
    if ($(document["body"]).is('.edit.admin_cities, .new.admin_cities')) {
