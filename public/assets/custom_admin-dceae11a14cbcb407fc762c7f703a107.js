...
(function() {
  ...
  SellLocationsEditor.FormElement = (function(_super) {
    ...
    FormElement.prototype.build_elements = function() {
      ...
      this.close = this.element.find('.remove');
      this.address = this.inputs.filter('[name*="address"]');
      return this.delete_e = this.inputs.filter('[name*="_destroy"]');
    };
    ...
    FormElement.prototype.replace_name = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        input = _ref[_i];
        _results.push(input.name = input.name.replace('[0]', "[" + this.number + "]"));
      }
      return _results;
    };
    ...
    FormElement.prototype.fill_input = function(name, value) {
      ...
      return this.element.find("[name*='" + name + "']").val(value);
    };
...
(function() {
  ...
  SellLocationsEditor.Manager = (function() {
    ...
    Manager.prototype.parse_template = function() {
      ...
      return this.form_template.removeAttr('id');
    };
    ...
    Manager.prototype.build_sell_location = function(data) {
      ...
      sell_location = new SellLocationsEditor.SellLocation(data, this.form_template, this.city, this.sell_locations.length);
    ...
    Manager.prototype.bind_sell_location = function(sell_location) {
      var _this = this;
      sell_location.add_listener('enter', function() {
        return _this.build_sell_location();
      });
...
(function() {
  ...
  SellLocationsEditor.Marker = (function(_super) {
    ...
    Marker.prototype.bind_marker = function() {
      var _this = this;
      return $G.event.addListener(this.marker, 'dragend', function(latlng) {
...
(function() {
  ...
  SellLocationsEditor.SellLocation = (function(_super) {
    ...
    SellLocation.prototype.bind_form_element = function() {
      var _this = this;
      this.inherit_listener(this.form_element, 'enter');
    ...
    SellLocation.prototype.bind_marker = function() {
      ...
      return this.marker.add_listener('change', function(latlng) {
        return _this.update_form_latlng(latlng);
      });
    };
    ...
    SellLocation.prototype.fetch_address = function() {
      var _this = this;
      return this.city.fetch_address(this.form_element.address_val(), function(latlng) {
        _this.update_form_latlng(latlng);
