class MDC.Directions.Controls.Slider.Element extends Utils.Eventable
  # Events
  # - change
  ...
  build_convertor: ->
    @convertor = new MDC.Directions.Controls.Slider.Convertor(@o.value, @o.min, @o.max, @o.min_bound, @o.max_bound, @element)
