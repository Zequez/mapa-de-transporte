class BusEditor.Route.AddressesManager.Address.Parser
  ...
  parse_address: ->
    ...
    @streets = for street in streets
      ...
      new BusEditor.Route.AddressesManager.Address.StreetParser(street)
...
class BusEditor.Route.AddressesManager.Address.StreetParser
  full_address: null
  comment:      null
  address:      null
  number:       null
